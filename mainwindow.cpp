    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->actPortuguese->setActionGroup(grupo);
    ui->actEnglish->setActionGroup(grupo);
    ui->actEspanish->setActionGroup(grupo);
    Criteria = NULL;
    CriteriaEdit = NULL;
    Alternative = NULL;
    Build = NULL;
...
void MainWindow::on_actConfiguration_triggered()
{
    ...
    ALTERLANGUAGE(Configurator->lblPrecision,"precision");
...
void MainWindow::on_actMatrixC_triggered()
{
    ...
    model->setHeaderData(0,Qt::Horizontal,Language::language("title"));
